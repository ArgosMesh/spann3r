...
class Spann3R(nn.Module):
    def __init__(self, dus3r_name="./checkpoints/DUSt3R_ViTLarge_BaseDecoder_512_dpt.pth", 
                 mem_pos_enc=False, memory_dropout=0.15):
        ...
        # Memory encoder
        self.set_memory_encoder(enc_embed_dim=1024, memory_dropout=memory_dropout) 
        self.set_attn_head()
        self.sp_mem = SpatialMemory(self.norm_q, self.norm_k, self.norm_v)
